...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    var broadcastText = (
      <div>
        <h4>Stream via WebRTC</h4>
        <p>Broadcast using our native SDKs or any software that supports WebRTC.</p>
      </div>
    );
    var transcodeText = (
      <div>
        <h4>Transcode and Store</h4>
        <p>Automatic transcoding and transmuxing for all desktop and mobile playback. Record directly to the cloud.</p>
      </div>
    );
    var watchText = (
      <div>
