            ...
            <ul className="icon-list">
              <li>
                <a target="_blank" href='https://addons.heroku.com/cine'>
                  <img src="//cdn.cine.io/images/partner-logos/heroku.png" alt="Heroku logo" title="Heroku Addon" />
                </a>
              </li>
              <li>
                <a target="_blank" href='https://console.run.pivotal.io/marketplace/cine-io'>
                  <img src="//cdn.cine.io/images/partner-logos/engineyard.png" alt="PWS logo" title="Pivotal Web Services Addon" />
                </a>
              </li>
              <li>
                <a target="_blank" href='https://addons.engineyard.com/addons/cineio'>
                  <img src="//cdn.cine.io/images/partner-logos/pivotal-web-services.png" alt="Engineyard logo" title="Engineyard Addon" />
                </a>
              </li>
              <li>
                <a target="_blank" href='https://marketplace.openshift.com/apps/14079'>
                  <img src="//cdn.cine.io/images/partner-logos/redhat-openshift.png" alt="OpenShift logo" title="OpenShift Addon" />
                </a>
              </li>
              <li>
                <a target="_blank" href='https://marketplace.samsungknox.com/apps/639'>
                  <img src="//cdn.cine.io/images/partner-logos/samsung-knox.png" alt="Samsung Knox logo" title="Samsung Knox Marketplace" />
                </a>
              </li>
            </ul>
          </div>
